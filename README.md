...
```bash
wget https://raw.githubusercontent.com/xiyan520/tg-telegram-imagebed/main/.env
...
```json
{
  ...
  "data": {
    ...
    "cdn_url": "https://cdn.your-domain.com/image/xxx",
    "delete_url": "https://your-domain.com/api/delete/xxx"
  }
}
```
...
```bash
DELETE /api/delete/<encrypted_id>
Authorization: Bearer <token>
```

更多 API 文档请访问：`http://your-domain/docs`
